...
function alterar(cpf){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        if (cliente.cpf == cpf){
            ...
            document.getElementById("Sexodacalopsita").value = cliente.Sexodacalopsita
...
function salvar(){
    ...
    let Sexodacalopsita = document.getElementById("Sexodacalopsita").value 
    ...
    if (clienteAlterado == null){
        let cliente = {
            ...
            "cpf": cpf,
            "telefone": telefone,
            "Sexodacalopsita": Sexodacalopsita,
        ...
        clienteAlterado.Sexodacalopsita = Sexodacalopsita
...
function exibirDados(){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        <tr>
            ...
            <td>${clientes[i].Sexodacalopsita}</td>
...
function limparForm(){
    ...
    document.getElementById("Sexodacalopsita").value = ""
